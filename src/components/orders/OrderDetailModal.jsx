  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {/* ─── Customer Details Card (Redesigned) ─── */}
        <div className="bg-gray-800/60 rounded-xl border border-gray-700/50 overflow-hidden">
          <div className="px-4 py-3 bg-gray-800 border-b border-gray-700/50 flex justify-between items-center">
            ...
            >
              {order.customerName ? "DINE-IN CUSTOMER" : "DELIVERY / TAKEOUT"}
            </span>
          </div>
          <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2 flex items-center gap-4">
              <div className="h-12 w-12 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/10 flex items-center justify-center shrink-0">
            ...
            {/* Placed By (User/Staff) - Priority Display */}
            <div className="flex items-center gap-3 bg-gray-900/30 p-2 rounded-lg border border-gray-800">
              <div className="w-8 h-8 rounded-lg bg-gray-800 flex items-center justify-center">
            ...
            {order.user?.email && (
              <div className="flex items-center gap-3 bg-gray-900/30 p-2 rounded-lg border border-gray-800">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300 font-medium truncate w-32">
                    {order.user.email}
                  </p>
                </div>
              </div>
            ...
            {order.address && (
              <div className="md:col-span-2 flex items-start gap-3 bg-gray-900/30 p-3 rounded-lg border border-gray-800">
          ...
          <div className="bg-purple-500/5 rounded-xl border border-purple-500/20 overflow-hidden">
            <div className="px-4 py-3 bg-purple-500/10 border-b border-purple-500/20 flex items-center justify-between">
              ...
              <span className="text-xs font-bold text-purple-300 bg-purple-500/20 px-2 py-0.5 rounded-full">
                Grand Total: {formatPrice(customerOrders.grandTotal)}
              </span>
            </div>
              ...
              <div className="space-y-2 max-h-[140px] overflow-y-auto pr-1 custom-scrollbar">
                {customerOrders.orders.map((cOrder) => {
                  ...
                  return (
                    <div
                      key={cOrder.id}
                      onClick={() => !isCurrentOrder && onOrderSelect?.(cOrder)}
                      className={`flex items-center justify-between px-3 py-2.5 rounded-lg text-sm border transition-all ${
                        isCurrentOrder
        ...
        <div className="bg-gray-800/30 rounded-xl border border-gray-700/50 overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-200 group-hover:text-white transition-colors">
                      {item.product?.name || item.deal?.name || "Unknown Item"}
                    </p>
                    {item.deal && (
          ...
          {/* Total Footer */}
          <div className="px-5 py-4 bg-gray-900/80 border-t border-gray-700/50 flex justify-between items-center">
